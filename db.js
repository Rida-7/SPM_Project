...
JOIN admin a ON a.admin_id = 41 -- Assuming there's a way to identify the specific admin; adjust as needed
WHERE o.status IN ('shipped', 'delivered') 
GROUP BY p.publisher_id, a.total_profit;
        `;
